    ...
    def render_html(self, docids, data=None):
        ...
        docargs['data'].update({'date_start':
                                parser.parse(docargs.get('data').
                                             get('date_start')).
                                strftime('%m/%d/%Y')})
        render_model = 'hotel_reservation.reservation_checkin_report_template'
    ...
    def render_html(self, docids, data=None):
        ...
        docargs['data'].update({'date_start':
                                parser.parse(docargs.get('data').
                                             get('date_start')).
                                strftime('%m/%d/%Y')})
        render_model = 'hotel_reservation.reservation_checkout_report_template'
        return self.env['report'].render(render_model, docargs)
    ...
    def render_html(self, docids, data=None):
        ...
        docargs['data'].update({'date_start':
                                parser.parse(docargs.get('data').
                                             get('date_start')).
                                strftime('%m/%d/%Y')})
        render_model = 'hotel_reservation.reservation_maxroom_report_template'
        return self.env['report'].render(render_model, docargs)
    ...
    def render_html(self, docids, data=None):
        ...
        docargs['data'].update({'date_start':
                                parser.parse(docargs.get('data').
                                             get('date_start')).
                                strftime('%m/%d/%Y')})
        render_model = 'hotel_reservation.reservation_room_report_template'
        return self.env['report'].render(render_model, docargs)
