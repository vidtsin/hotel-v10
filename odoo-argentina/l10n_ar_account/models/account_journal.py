...
class AccountJournal(models.Model):
    ...
    def create(self, vals):
        if 'bank_id' in vals and 'bank_acc_number' in vals:
            if vals['bank_id'] != False and vals['bank_acc_number'] == False:
                raise UserError(_('Should Complete account number too in order to save it'))
