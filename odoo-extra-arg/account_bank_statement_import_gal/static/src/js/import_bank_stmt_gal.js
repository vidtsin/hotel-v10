odoo.define('bank_stmt_import_gal.import', function (require) {
"use strict";
...
var DataImportStmt = BaseImport.DataImport.extend({
    init: function (parent, action) {
        ...
        action.display_name = _t('Import Galicia Statement'); // Displayed in the breadcrumbs
    ...
    import_options: function () {
        ...
        options['bank_stmt_import_gal'] = true;
        return options;
    },
